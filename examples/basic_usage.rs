...
fn main() -> anyhow::Result<()> {
    ...
    // 1. 创建几何图元
    println!("1. 创建几何图元");
    let room_boundary = Polygon::from_coords(vec![
        [0.0, 0.0],
        [500.0, 0.0],
        [500.0, 400.0],
        [0.0, 400.0],
    ...
    println!("   感知：{}", cot_data.perception.chars().take(100).collect::<String>());
    println!("   推理：{}", cot_data.reasoning.chars().take(100).collect::<String>());
