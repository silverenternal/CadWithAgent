...
mod tests {
    use crate::geometry::{
        boolean::{
            difference, intersection, line_intersection, lines_intersect, point_in_polygon,
            polygons_intersect, union, BooleanOp, BooleanResult,
        },
        Point, Polygon,
    };
    ...
    fn test_point_in_polygon_degenerate() {
        // 少于 3 个顶点的多边形
        let line_polygon = Polygon::new(vec![Point::new(0.0, 0.0), Point::new(10.0, 0.0)]);
