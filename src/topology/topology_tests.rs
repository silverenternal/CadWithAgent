...
#[cfg(test)]
mod tests {
    use crate::geometry::{Point, Line, Primitive, Door, Window, DoorDirection, Polygon, Room};
    use crate::topology::{
        detect_doors_in_wall, detect_windows_in_wall,
        DoorWindowDetector,
        detect_rooms, RoomDetectionResult,
    };
    ...
    fn test_detect_rooms_basic() {
        ...
        let lines = vec![
            ...
            Primitive::Line(Line::new(Point::new(1000.0, 0.0), Point::new(1000.0, 1000.0))),
            Primitive::Line(Line::new(Point::new(1000.0, 1000.0), Point::new(0.0, 1000.0))),
